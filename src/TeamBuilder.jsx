    ...
    <div style={{flex:1,overflowY:"auto",padding:"24px 28px 60px",background:T.paperDeep}}>
      ...
      {stage===3&&runState==="done"&&(
        <div>
          ...
          {/* Results side by side — min 560px per card so reports are fully readable */}
              ...
              return(
                <div key={agentId} style={{display:"flex",flexDirection:"column"}}>
                  ...
                  <div style={{background:T.card,border:`1px solid ${T.line}`,borderTop:"none",padding:"16px 18px",flex:1}}>
                    <div style={{fontFamily:body,fontSize:12.5,color:T.mutedDeep,lineHeight:1.7,overflowX:"auto","--report-max-width":"none"}}
                      dangerouslySetInnerHTML={{__html:(()=>{
                        ...
                        if(stripped.startsWith("<")){
                          ...
                          // Neutralize any model-injected page layout styles
                          return `<style>*{max-width:none!important;width:auto!important;box-sizing:border-box!important}body,html{margin:0!important;padding:0!important}</style>${html}`;
                        }
                        return stripped
