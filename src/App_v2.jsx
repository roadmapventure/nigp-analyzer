  ...
  const Header = ()=>(
    <div style={{background:"linear-gradient(135deg,#0a1929 0%,#0d2137 50%,#091520 100%)",borderBottom:"1px solid #1a3548",padding:"16px 24px",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}}>
      ...
      <div style={{display:"flex",gap:8,alignItems:"center"}}>
        ...
        {/* Admin button — opens RAG admin in new tab */}
        <button
          onClick={()=>window.open("/admin","_blank")}
          style={{background:"transparent",border:"1px solid #1e3a4a",color:"#7aafc9",borderRadius:8,padding:"7px 14px",cursor:"pointer",fontSize:12,display:"flex",alignItems:"center",gap:6}}
        >
                ...
                <div style={{maxWidth:"100%"}}>
                  ...
                  {aiResult&&!aiLoading&&(
                    <div style={{background:"#0a1729",border:"1px solid #A45CFF44",borderRadius:16,padding:"32px 40px"}}>
                      ...
                      {/* AI brief body — scoped to prevent injected HTML from affecting layout */}
                      <div style={{fontSize:14,lineHeight:1.8,color:"#c8dcea",width:"100%",overflowX:"hidden"}} dangerouslySetInnerHTML={{__html:aiResult}}/>
