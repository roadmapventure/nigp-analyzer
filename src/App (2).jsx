          ...
          <div style={{flex:1,display:"flex",flexDirection:"column",background:T.navyDeep||"#0b1929",overflow:"hidden"}}>
            ...
            <div style={{flex:1,display:"flex",alignItems:"stretch",overflow:"hidden",position:"relative"}}>
              {fetchEvents.length>0&&fetchEvents[fetchEvents.length-1]?.screenshot
                ? <img src={`data:image/jpeg;base64,${fetchEvents[fetchEvents.length-1].screenshot}`} alt="Browser screenshot" style={{width:"100%",height:"100%",objectFit:"contain",objectPosition:"top center",display:"block",position:"absolute",inset:0}}/>
